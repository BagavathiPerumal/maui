...
public class Issue33351 : Shell
{
    public Issue33351()
    {
        ...
        // Two ShellContent items are needed so the TabBar is rendered visible by default.
        // MyTab handles show/hide: visible when this tab is active, hidden when navigating away.
    ...
    class MyTab : ShellContent
    {
        protected override void OnAppearing()
        {
            ...
            // Remove before adding to prevent accumulating duplicate handlers
